...
`src/main/inspector_repro/client.cljs` contains the code to start and refresh
...
application `inspector-repro.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/inspector_repro.jar
```
